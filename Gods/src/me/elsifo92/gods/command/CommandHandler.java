			    	...
			    	switch(args[0])
			    	{
			    	    ...
			    	    case "create":
			    	    {
			    		    if(args.length>1)
			    		    {
			    		        ...
			    		        Block b=((CraftPlayer) p).getTargetBlock(null, 10);
			    	    ...
			    	    case "delete":
			    	    {
			    		    if(args.length>1)
			    		    {
			    		        if(args[1].equals("altar"))
			    		        {
			    		        	...
			    		        	AltarManager.removeAltar(p,((CraftPlayer) p).getTargetBlock(null, 10));
			    		        	return true;
			    		        }
			    		        else return false;
			    		    }			    		  	   
			    	    ...
			    	    case "verify":
			    	    {
			    		    ...
			    		    else 
			    		    {
			    		    	...
			    		    	if(BlockManager.verifyBlock(((CraftPlayer) p).getTargetBlock(null, 10))) p.sendMessage(Utility.formattedMessage("Questo blocco non £ naturale"));
